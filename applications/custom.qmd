...
By default, this will initialise conda and modify your `~/.bashrc`, which can interfere negatively with the functionality of batch submissions. Furthermore, it may then not interact well with Strudel2 and our Jupyter App. 
