...
The installer will prompt you to initislise conda and edit the `.bashrc` so that it will activate when you log in. This is **NOT** reccommended as this can lead to unexpect interactions with batch jobs. If you have done so by accident you can remove the additions to your `.bashrc` file manually (this is located in your home directory).
