...
If you prefer using VS Code to the Jupyter Lab IDE you can also connect to this job [Remote Development Extension Pack](https://aka.ms/vscode-remote/download/extension). For more details see our page on [connecting via VS Code](/connecting/vscode.qmd).
