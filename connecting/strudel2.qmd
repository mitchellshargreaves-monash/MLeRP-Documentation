...
You can visit the [Base](/applications/environments/base.ipynb) and [DSKS](/applications/environments/dsks.ipynb) pages complete lists of packages and versions in each environment.
...
Have a look at [this page](/applications/environments/custom.qmd) for more information about creating a conda environment to interface with our environment.
