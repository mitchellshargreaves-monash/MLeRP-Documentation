...
## Jupyter Lab
The easiest option to move files into the {{< var cluster_name >}} environment is to use a Jupyter Lab job through Strudel2 since it requires no additional setup. You should be able to drag and drop files into the filetree on the left though it comes with some limitations. 
