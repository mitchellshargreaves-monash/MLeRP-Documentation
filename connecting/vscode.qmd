...
Note that you will need to authenticate with your ssh key/cert, either through your authorized keys file [or by generating a cert with ssossh](/connecting/ssossh.qmd). You can then add it to your agent or provide it to the ssh command (and proxy command) with the `-i` flag.
