...
### 1. Optionally allocate resources for the remote server (i.e. start a job)
...
You should now have an active connection to the cluster. Using `File > Open File` or `File > Open Folder` will open files and projects on the cluster.
