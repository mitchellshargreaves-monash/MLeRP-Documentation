...
Most users will find that the easiest way to start using MLeRP will be through the [Strudel2 Web Interface](/connecting/strudel2.qmd). Here you can find the `Terminal` and `Jupyter Lab` applications we have prepared for you. 

We have provided [some python environments](/connecting/strudel2.qmd#conda-environments) for you so you can get started right away, until you eventually outgrow them and feel like you need more control over the environment. At this point, we can help you to transition to maintaining your own environment with whatever applications and packages you need. 
